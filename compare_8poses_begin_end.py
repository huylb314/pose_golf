...
for idx_neg, (pairs_, image_file_, raw_) in enumerate(zip(np_kp_pairs_neg, image_file_neg, raw_neg)): 
    ...
    p12_abs = (np_angle_pos[p12_argmin] - np_angle_neg[idx_neg])
    ...
    # mmcv.imwrite(image_pos_temp, "./{}".format(os.path.basename(image_file_)))
    mmcv.imwrite(image_neg_temp, "./{}_{}.jpg".format(idx_neg, p12_argmin))
